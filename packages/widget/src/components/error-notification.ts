...
export function renderErrorNotification(errorMessage: string | null): TemplateResult {
  ...
  return html`
    <div class="sr:fixed sr:top-4 sr:right-4 sr:left-4 sm:sr:left-auto sm:sr:max-w-sm sr:z-[10000] sr:animate-[slideIn_0.3s_ease-out]">
      <div class="sr:bg-red-50 sr:border sr:border-red-200 sr:text-red-800 sr:rounded-lg sr:p-4 sr:shadow-lg sr:flex sr:items-start sr:gap-3">
...
export function renderSuccessNotification(message: string | null): TemplateResult {
  ...
  return html`
    <div class="sr:fixed sr:top-4 sr:right-4 sr:left-4 sm:sr:left-auto sm:sr:max-w-sm sr:z-[10000] sr:animate-[slideIn_0.3s_ease-out]">
      <div class="sr:bg-green-50 sr:border sr:border-green-200 sr:text-green-800 sr:rounded-lg sr:p-4 sr:shadow-lg sr:flex sr:items-start sr:gap-3">
