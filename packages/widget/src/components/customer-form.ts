          ...
          ${!this.isGuest ? html`
            ...
            <div class="sr-account-notice">
              ...
              <div class="sr-account-notice-text">
                <strong>${t('checkout.account_notice_title', 'Your order history')}</strong>
                <p>${t('checkout.account_notice_body', 'Use this email to sign in any time with a one-time code. No password to remember.')}</p>
              </div>
            </div>
          ` : ''}
        </div>
